...
- path: /etc/sysctl.d/01-graylog.conf
  content: |
    vm.max_map_count = 262144
- path: /etc/rsyslog.d/31-graylog.conf
  content: |
    :syslogtag, startswith, "graylog" /var/log/graylog.log
runcmd:
  ...
  - [ cloud-init-per, once, "read-custom-syslog", "sysctl", "-p", "/etc/sysctl.d/01-graylog.conf"]
